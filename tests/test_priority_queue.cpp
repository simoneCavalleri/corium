...
TEST(PriorityQueueTest, EventBusPriorityDispatch)
{
    ...
    class PriorityTestApp : public Application<PriorityTestApp, PriorityRuntime::EventBusType> {
    public:
...
TEST(PriorityQueueTest, ConcurrentMultiProducerPush)
{
    ...
    class MultiProducerApp : public Application<MultiProducerApp, PriorityRuntime::EventBusType> {
    public:
